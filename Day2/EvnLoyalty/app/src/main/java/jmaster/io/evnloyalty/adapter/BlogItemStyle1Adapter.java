...
public class BlogItemStyle1Adapter extends RecyclerView.Adapter<BlogItemStyle1Adapter.ViewHolder> {
    private List<Post> posts;
    private LayoutInflater mInflater;

    public BlogItemStyle1Adapter(Activity context, List<Post> posts) {
        this.posts = posts;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.adapter_blog_item_style_1, parent, false);
