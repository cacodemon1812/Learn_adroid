...
public class MyListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup container) {
        ...
        ((TextView) convertView.findViewById(R.id.textViewTitle)).setText(categoryList.get(position).getName());
        ((TextView) convertView.findViewById(R.id.textViewDescription)).setText(categoryList.get(position).getDescription());
        return convertView;
    }
}
